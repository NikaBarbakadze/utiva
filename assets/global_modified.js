...
class VariantSelects extends HTMLElement {
  ...
  updateSellingPlanContainers() {
    ...
    const sellingPlansWrapper = document.querySelectorAll(
      ".product_selling_plans_wrapper"
    );
    ...
    const sellingPlanWrappers = document.querySelectorAll(
      ".product_selling_plans_wrapper.active .product_selling_plan"
    );
